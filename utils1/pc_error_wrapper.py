...
def pc_error(infile1, infile2, res, normal=True, show=False):
    ...
    command = str('/home/zpc/Documents/gpcc_python_color_geo/extension/utils/pc_error' +
                  ' -a ' + infile1 +
                  ' -b ' + infile2 +
                  # ' -n '+infile1+
                  ' --color=1 ' +
